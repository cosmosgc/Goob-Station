...
cmd-whitelistadd-arg-player = %ERASE_NEWLINE%[player]
...
cmd-whitelistremove-arg-player = %ERASE_NEWLINE%[player]
...
cmd-blacklistadd-arg-player = %ERASE_NEWLINE%[player]
...
cmd-blacklistremove-arg-player = %ERASE_NEWLINE%[player]
