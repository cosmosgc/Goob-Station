alerts-low-oxygen-name = %ERASE_NEWLINE%[color=red]Low Oxygen[/color]
...
alerts-low-nitrogen-name = %ERASE_NEWLINE%[color=red]Low Nitrogen[/color]
...
alerts-high-toxin-name = %ERASE_NEWLINE%[color=red]High Toxin Level[/color]
...
alerts-low-pressure-name = %ERASE_NEWLINE%[color=red]Low Pressure[/color]
...
alerts-high-pressure-name = %ERASE_NEWLINE%[color=red]High Pressure[/color]
...
alerts-on-fire-name = %ERASE_NEWLINE%[color=red]On Fire[/color]
...
alerts-too-cold-name = %ERASE_NEWLINE%[color=cyan]Too Cold[/color]
...
alerts-too-hot-name = %ERASE_NEWLINE%[color=red]Too Hot[/color]
...
alerts-stunned-name = %ERASE_NEWLINE%[color=yellow]Stunned[/color]
...
alerts-handcuffed-name = %ERASE_NEWLINE%[color=yellow]Handcuffed[/color]
...
alerts-ensnared-name = %ERASE_NEWLINE%[color=yellow]Ensnared[/color]
alerts-ensnared-desc = You're [color=yellow]ensnared[/color] and is impairing your ability to move.
alerts-buckled-name = %ERASE_NEWLINE%[color=yellow]Buckled[/color]
...
alerts-crit-name = %ERASE_NEWLINE%[color=red]Critical Condition[/color]
...
alerts-health-desc = %ERASE_NEWLINE%[color=green]Green[/color] good. [color=red]Red[/color] bad.
...
alerts-hunger-name = %ERASE_NEWLINE%[color=yellow]Peckish[/color]
...
alerts-starving-name = %ERASE_NEWLINE%[color=red]Starving[/color]
alerts-starving-desc = You're severely malnourished. The hunger pains make moving around a chore.
alerts-thirsty-name = %ERASE_NEWLINE%[color=yellow]Thirsty[/color]
alerts-thirsty-desc = Something to drink would be good right about now.
alerts-parched-name = %ERASE_NEWLINE%[color=red]Parched[/color]
...
alerts-bleed-name = %ERASE_NEWLINE%[color=red]Bleed[/color]
alerts-bleed-desc = You're [color=red]bleeding[/color].
alerts-pacified-name = %ERASE_NEWLINE%[color=green]Pacified[/color]
alerts-pacified-desc = You're pacified; you won't be able to harm living creatures.
alerts-adrenaline-name = %ERASE_NEWLINE%[color=red]Adrenaline[/color]
